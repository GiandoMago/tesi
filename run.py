...
from query_strategies import RandomSampling, BadgeSampling, \
                                ...
                                AdversarialBIM, AdversarialDeepFool, ActiveLearningByLearning, BaitSampling, TesiDistance
...
elif opts.alg == 'tesi': # da lanciare per la tesi
    strategy = TesiDistance(X_tr, Y_tr, idxs_lb, net, handler, args)
else: 
